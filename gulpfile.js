...
const configHTML = [
	...
	//'src/html/insights.html',
	//'src/html/data.html',
	//'src/html/stories.html',
	//'src/html/library.html',
	'src/html/survey.html',
	//'src/html/contact.html',
	//'src/html/methodology.html',
	'src/html/footer.html',
	'src/html/top-map.html',
	'src/html/modal.html',
	'src/html/end.html'
	//'src/html/insight-Q3.html',
	//'src/html/carousel-Q3.html',
];
...
const banner = [
	'/*',
	'ManpowerGroup Candidate Preferences',
	'Created: ' + dateTime,
	'*/',
	''
].join("\n");
